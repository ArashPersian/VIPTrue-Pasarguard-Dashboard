...
const budgets = {
  // PasarGuard v5.4.1 pristine build is ~22.22 MB; the official VIPTrue PNG
  // brings the expected release output to ~22.54 MB including 404.html.
  totalBuild: 22_600_000,
